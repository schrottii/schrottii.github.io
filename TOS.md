...
By using this product (game, tool, or mod), you agree to these rules. 
...
*   **No Manipulation:** You are prohibited from automating or manipulating provided features or exploiting the cloud save system to inject malicious data.
*   **Data Integrity:** You agree not to upload corrupted or manipulated save files, or other data, to our servers.

## 2. Service Availability:
We do not guarantee that server-side features or websites hosted online are reachable at all times. Downtimes for maintenance, updates, or technical issues may occur without prior notice.

## 3. Server-Side Features
*   Features like "Player Count" or "Leaderboards" are provided as-is. We do not guarantee 100% uptime.
...
If you submit suggestions, concept art, or sprites to us (via Discord, E-Mail, or other methods), you grant us a non-exclusive, royalty-free, perpetual license to use, modify, and implement these ideas or assets into our products.

    Ownership: You retain the copyright to your original work, but you agree that we can use it in our games/tools without compensation.
    Credit: We may (but are not obligated to) provide credit to you within the game or its documentation.
	Contact: If you wish to have credit added, the content changed, or removed, please contact us. However, we can not guarantee to fulfill the request (such as removing a game feature important for progression).
