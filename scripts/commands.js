...
commandDisplays.quotequiz.innerHTML = `alert("After executing this, a rescue code that can be used to restore your save should appear at the end of the page!");var restoreMyQuiz=localStorage["QUOTEQUIZ"];document.body.innerHTML+="<br/><br/><br/>faCoDeFUVE"+restoreMyQuiz;`;
